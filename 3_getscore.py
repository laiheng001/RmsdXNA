...
if __name__ == "__main__":
    ...
    parser.add_argument("-folder_dock", type=str, default="docking", help = "Folder containing ligand features .csv files for prediction")
    parser.add_argument("-cutoff", type=float, default=8, help = "Cutoff distance for feature extraction")
    parser.add_argument("-log", type=str, default="error_getscore.log", help = ".log file to record error")
